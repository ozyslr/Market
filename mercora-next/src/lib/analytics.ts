...
/**
 * Centralized analytics service — GA4 + Meta Pixel + TikTok Pixel
...
function getIds() {
  return {
    ga: process.env.NEXT_PUBLIC_GA4_MEASUREMENT_ID || process.env.NEXT_PUBLIC_GA_MEASUREMENT_ID as string | undefined,
    meta: process.env.NEXT_PUBLIC_META_PIXEL_ID as string | undefined,
    tiktok: process.env.NEXT_PUBLIC_TIKTOK_PIXEL_ID as string | undefined,
  };
}
