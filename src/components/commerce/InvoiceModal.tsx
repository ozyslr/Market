  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Modal Header */}
          <div className="flex items-center justify-between px-8 py-5 border-b border-brand-primary/5">
          ...
          <div id="invoice-print-root" ref={printRef} className="px-8 py-6 space-y-6">
            ...
            <div className="flex items-start justify-between">
              <div>
                <h1 className="text-3xl font-bold tracking-tight text-brand-primary">Benim Olan</h1>
              ...
              <div className="text-end">
                ...
                <p className="text-[10px] font-bold text-brand-primary/40 mt-1">{invoiceDate}</p>
              </div>
            </div>

            {/* Bill To / Ship To */}
            <div className="grid grid-cols-2 gap-6 py-5 border-t border-b border-brand-primary/5">
              <div>
                ...
                <p className="text-[11px] font-bold text-brand-primary/50">{order.userEmail}</p>
              </div>
              <div>
                <p className="text-[9px] font-black uppercase tracking-widest text-brand-primary/30 mb-2">
                  Teslimat Adresi
                ...
                {order.shippingAddress ? (
                  <>
                    ...
                    <p className="text-[11px] font-bold text-brand-primary/50 leading-relaxed">
                  ...
                  <p className="text-[11px] text-brand-primary/40">—</p>
                )}
              </div>
            </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-brand-primary/10">
                  <th className="text-start py-2 text-[9px] font-black uppercase tracking-widest text-brand-primary/40 pb-3">
                    Ürün
                  </th>
                  <th className="text-center py-2 text-[9px] font-black uppercase tracking-widest text-brand-primary/40 pb-3">
                    Adet
                  </th>
                  <th className="text-end py-2 text-[9px] font-black uppercase tracking-widest text-brand-primary/40 pb-3">
                    Birim
                  </th>
                  <th className="text-end py-2 text-[9px] font-black uppercase tracking-widest text-brand-primary/40 pb-3">
                    Toplam
              ...
              <tbody className="divide-y divide-[#1A1033]/5">
                {order.items.map((item, i) => (
                  <tr key={i}>
                    <td className="py-3 font-bold text-brand-primary text-[12px] max-w-[200px]">
                      <span className="line-clamp-2">{item.name}</span>
                    </td>
                    <td className="py-3 text-center font-black text-brand-primary/60 text-[12px]">
                      {item.quantity}
                    </td>
                    <td className="py-3 text-end font-black text-brand-primary text-[12px]">
                      {currencySymbol}
            ...
            {/* Totals */}
            <div className="ms-auto w-64 space-y-2 pt-4 border-t border-brand-primary/10">
              <div className="flex justify-between text-[11px]">
                <span className="text-brand-primary/50 font-bold">Ara Toplam</span>
              ...
              <div className="flex justify-between text-[11px]">
                <span className="text-brand-primary/50 font-bold">Kargo</span>
                <span className="font-black text-brand-primary">
                  {currencySymbol}
              ...
              <div className="flex justify-between text-[11px]">
                <span className="text-brand-primary/50 font-bold">KDV / VAT</span>
                <span className="font-black text-brand-primary">
                  {currencySymbol}
                  {order.tax.toFixed(2)}
                </span>
              </div>
              <div className="flex justify-between text-sm pt-3 border-t-2 border-brand-primary/10">
            ...
            <div className="bg-[#F8F8FA] rounded-2xl px-5 py-4 mt-4">
              <div className="flex items-center justify-between text-[10px] font-black uppercase tracking-widest">
                <span className="text-brand-primary/40">Ödeme Durumu</span>
            ...
            {/* Footer */}
            <p className="text-center text-[9px] text-brand-primary/20 font-bold uppercase tracking-widest pt-4 border-t border-brand-primary/5">
