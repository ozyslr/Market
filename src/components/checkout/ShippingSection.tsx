    ...
    <div className="mb-4 pt-4 border-t border-[#1A1033]/5">
      ...
      {ratesLoading ? (
        <div className="flex items-center gap-2 px-3 py-3 bg-[#F8F8FA] rounded-xl">
          ...
          <span className="text-[11px] font-bold text-[#1A1033]/50">
              ...
              >
                <span className="flex items-center gap-2 min-w-0">
                  ...
                  <span className="min-w-0">
                    <span className="block text-[11px] font-black text-[#1A1033] truncate">
                      {CARRIER_LABELS[rate.provider] ?? rate.provider}
                    </span>
                    <span className="block text-[9px] font-bold text-[#1A1033]/40">
                      {rate.estimatedDays} iş günü
                    </span>
                  </span>
                </span>
                <span className="text-[11px] font-black text-[#1A1033] shrink-0">
                  {curSym}
