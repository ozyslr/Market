    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden bg-brand-primary text-white">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          >
            Join 450+ elite UK and global sellers. From £0 to £1M revenue with Mercora's AI-driven
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            {[
              ...
              >
                <span className="absolute -top-10 -right-10 text-[10rem] font-display font-black text-brand-primary/5 group-hover:text-accent/10 transition-colors">
                  {card.step}
                </span>
        ...
        <div className="max-w-5xl mx-auto bg-brand-primary rounded-[4rem] p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/60 mb-12 max-w-xl mx-auto font-medium">
              Limited spots available for UK Artisan Merchants for the 0% commission launch phase.
            </p>
            <Link
              to="/sell/apply"
              className="px-12 py-5 bg-accent text-white rounded-2xl font-black uppercase tracking-widest text-xs shadow-2xl shadow-accent/40 hover:scale-105 transition-all inline-block"
            >
              Join the Waitlist
            </Link>
          </div>
