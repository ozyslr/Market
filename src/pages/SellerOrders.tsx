...
export function SellerOrdersPage() {
  ...
  // Simulation of seller orders
  const orders = [
    { id: 'ORD-8821', date: '2026-04-18', buyer: 'Alice M.', total: 249.99, status: 'pending', destination: 'London, UK', urgency: 'High' },
    { id: 'ORD-8822', date: '2026-04-17', buyer: 'Khalid A.', total: 120.00, status: 'shipped', destination: 'Riyadh, KSA', urgency: 'Standard' },
    { id: 'ORD-8823', date: '2026-04-17', buyer: 'Marie L.', total: 899.00, status: 'delivered', destination: 'Paris, FR', urgency: 'Standard' },
    { id: 'ORD-8824', date: '2026-04-16', buyer: 'James T.', total: 19.99, status: 'shipped', destination: 'Dubai, UAE', urgency: 'High' },
    { id: 'ORD-8825', date: '2026-04-16', buyer: 'Sophie W.', total: 45.00, status: 'pending', destination: 'Berlin, GER', urgency: 'Standard' }
  ];
                      ...
                      <tr key={order.id} className="group hover:bg-brand-secondary/20 transition-colors">
                         <td className="px-10 py-6">
                            <div>
                               ...
                               <p className="text-[10px] font-bold text-brand-primary/30 uppercase tracking-widest">{new Date(order.date).toLocaleDateString()} at 10:42 AM</p>
                            </div>
                         </td>
                         <td className="px-10 py-6">
                            <div className="flex items-center gap-3">
                               ...
                               <div>
                                  <p className="text-sm font-bold text-brand-primary">{order.buyer}</p>
                                  <p className="text-[10px] font-bold text-accent uppercase tracking-widest">Multi-Item Parcel</p>
                               </div>
                            </div>
                         </td>
                         <td className="px-10 py-6">
                            <div className="flex items-center gap-2">
                               ...
                               <span className="text-sm font-bold text-brand-primary">{order.destination}</span>
                         ...
                         <td className="px-10 py-6">
                            <div className={cn(
                              ...
                              "bg-orange-50 text-orange-600"
                               ...
                               {order.status}
                               {order.urgency === 'High' && <Zap size={10} className="fill-current" />}
                            </div>
                         </td>
                         <td className="px-10 py-6">
