...
export function AdminUsers() {
  ...
  const statusBadge = (u: User) => {
    ...
    return (
      <span
        className={cn('px-2 py-0.5 rounded-full text-[9px] font-black uppercase', {
  ...
  const roleBadgeClass = (role: UserRole) =>
    cn('px-2 py-0.5 rounded-full text-[9px] font-black uppercase border', {
  ...
  return (
    <div className="bg-white rounded-[3.5rem] p-12 border border-[#F8F8FA] shadow-sm flex flex-col min-h-[500px]">
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        ...
        <span className="ms-auto text-[10px] font-bold text-gray-400 self-center">
                ...
                >
                  ...
                  <td className="px-6 py-5">
                    <div className="relative inline-block" onClick={(e) => e.stopPropagation()}>
                      <select
                        ...
                        className={cn(
                          'appearance-none ps-2 pe-6 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest border cursor-pointer outline-none',
                          {
                            ...
                            'bg-brand-secondary text-brand-primary/60 border-transparent':
                              u.role === 'buyer',
                          },
                        )}
                      >
                      ...
                      <ChevronDown
                        size={10}
                        className="absolute end-1.5 top-1/2 -translate-y-1/2 pointer-events-none opacity-50"
                      />
                    </div>
                  </td>
      ...
      {selectedUser && (
        <div className="fixed inset-y-0 end-0 w-96 bg-white shadow-2xl z-50 p-6 overflow-y-auto border-s border-gray-100">
          <button
            ...
            className="mb-5 text-xs text-gray-400 hover:text-accent flex items-center gap-1"
          >
            <X size={12} /> Kapat
          </button>
          ...
          <div className="bg-white rounded-3xl p-8 w-80 shadow-2xl">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-2 border border-gray-200 rounded-xl text-xs font-bold"
              >
                İptal
              </button>
              <button
                ...
                className="flex-1 py-2 bg-yellow-500 text-white rounded-xl text-xs font-black disabled:opacity-40"
              >
                Askıya Al
              </button>
            </div>
          ...
          <div className="bg-white rounded-3xl p-8 w-80 shadow-2xl">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={handleBan}
                disabled={!actionReason.trim()}
                className="flex-1 py-2 bg-red-600 text-white rounded-xl text-xs font-black disabled:opacity-40"
              >
                Engelle
              </button>
            </div>
