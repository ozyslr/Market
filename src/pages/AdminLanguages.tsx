...
export function AdminLanguages() {
  const { availableLanguages, setAvailableLanguages, translations, setTranslations } = useLanguage();
      ...
      <div className="flex items-end justify-between bg-white dark:bg-zinc-900 p-8 rounded-[3rem] shadow-sm border border-brand-primary/5 dark:border-white/5">
        <div>
           <div className="flex items-center gap-3 mb-2">
             ...
             <h2 className="text-3xl font-display font-black uppercase italic tracking-tighter text-brand-primary dark:text-white">Dil Yönetimi</h2>
           </div>
           <p className="text-xs font-bold text-brand-primary/40 dark:text-white/40 uppercase tracking-widest pl-13">Çoklu dil seçeneği ayarları ve çeviri stüdyosu</p>
        </div>
