...
export function UserSupport() {
  ...
  const handleReply = async () => {
    ...
    try {
      ...
      setTickets((prev) =>
        prev.map((t) =>
          t.id === selectedTicket.id ? { ...t, messages: [...t.messages, msg] } : t,
        ),
      );
      setReplyText('');
    } finally {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-2">
            {loading ? (
              ...
              <div className="bg-white rounded-2xl p-8 text-center border border-brand-primary/5">
                <MessageCircle size={32} className="mx-auto mb-3 text-brand-primary/20" />
                <p className="text-xs font-bold text-brand-primary/40">Henüz biletiniz yok.</p>
              </div>
            ) : (
              tickets.map((ticket) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-2 mb-1">
                      ...
                      <ChevronRight size={12} className="text-brand-primary/30 shrink-0 mt-0.5" />
                    </div>
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      <span
                        className={cn(
                          'ms-auto text-[9px] font-black uppercase',
          ...
          <div className="lg:col-span-2">
            {showNewForm ? (
              <div className="bg-white rounded-2xl border border-brand-primary/5 p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    ...
                    className="p-1 text-brand-primary/40 hover:text-accent"
                  >
                    <X size={16} />
                  </button>
                </div>
                <div className="space-y-4">
                  <div>
                    <label className="text-[9px] font-black uppercase tracking-widest text-brand-primary/40 mb-1 block">
                      Konu
                    </label>
                    <input
                      value={form.subject}
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border border-brand-primary/10 text-sm font-bold outline-none focus:border-accent/50 bg-[#F8F8FA]"
                    />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2.5 rounded-xl border border-brand-primary/10 text-sm font-bold outline-none focus:border-accent/50 bg-[#F8F8FA]"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-brand-primary/10 text-sm font-bold outline-none focus:border-accent/50 bg-[#F8F8FA] resize-none"
                    />
                  </div>
                  <button
              ...
              <div
                className="bg-white rounded-2xl border border-brand-primary/5 flex flex-col"
              ...
              <div className="bg-white rounded-2xl border border-brand-primary/5 flex flex-col items-center justify-center py-24 gap-4 text-brand-primary/20">
