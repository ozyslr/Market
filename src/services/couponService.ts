import { collection, doc, getDocs, setDoc, updateDoc, deleteDoc, query, where, increment, serverTimestamp } from 'firebase/firestore';
...
export async function validateCoupon(
  ...
  try {
    ...
    if (coupon.expiresAt && new Date(coupon.expiresAt) < new Date())
      return { valid: false, error: 'coupon.invalid' };
