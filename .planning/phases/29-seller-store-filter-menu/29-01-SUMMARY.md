...
- Fırsat Ürünleri: filtered deals grid + same sidebar
- Sidebar: seller profile card + category/brand/price/rating/advantage filters
- Sidebar hidden on Ana Sayfa (full-width blocks)
